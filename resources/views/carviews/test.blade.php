...
<head>
    ...
    <title>YourAuto.bg - Начална страница</title>
    ...
    <div class="container">
        ...
        <div class="collapse navbar-collapse" id="navbarExample">
            <ul class="navbar-nav ml-auto">
                ...
                <li class="nav-item">
                    <a class="nav-link" href="#">Открий своя автомобил</a>
                </li>
                <li class="nav-item">
                    <a class="nav-link" href="#">Продай своя автомобил</a>
                </li>
                <li class="nav-item">
